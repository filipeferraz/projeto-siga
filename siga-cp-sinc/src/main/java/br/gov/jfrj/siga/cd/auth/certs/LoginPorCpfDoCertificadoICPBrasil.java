...
public class LoginPorCpfDoCertificadoICPBrasil extends BaseCertLoginModule
    ...
    private static final Logger log = Logger
            .getLogger(LoginPorCpfDoCertificadoICPBrasil.class);
	...
	public boolean login() throws LoginException {
		...
		super.loginOk = true;
		log.trace("Usuario '" + identity + "' authenticado, loginOk="
				+ loginOk);
		return true;
	}
	...
	public boolean validateCredential(X509Certificate cert, String alias,
		...
		try {
			...
			log.trace("Usuario " + cert.getSubjectDN().getName() + " com credencial inválida:"
					+ e.getMessage());
