...
public class RelatorioBaseTest {
	...
	public static void main(String[] args) throws Exception {
		...
		rel.setTitle("Relat�rio de Modelos");		
		...
		rel.addColuna("Class Cria��o", 15,RelatorioRapido.CENTRO,false,true);
		...
		for (int i=0; i<100; i++){
			...
			dados.add("Class Cria��o_ddddd"+ i);
		...
		dados.add("Class Cria��o_ddddd"+ 1);
