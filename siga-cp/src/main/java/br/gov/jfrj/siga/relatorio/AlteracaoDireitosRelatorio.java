...
public class AlteracaoDireitosRelatorio extends RelatorioTemplate {
	...
	public AbstractRelatorioBaseBuilder configurarRelatorio()
		...
		this.addColuna("Situa��o Inicial", 10, RelatorioRapido.ESQUERDA, false,
				false);
		this.addColuna("Situa��o Final", 10, RelatorioRapido.ESQUERDA, false,
				false);
		return this;
	}
	...
	/**
	 * Obt�m uma lista ordenada com as configura��esAcesso na data
	 * 
	 * @param ou
	 *            Org�o Usu�rio
	 * @param dtEvn
	...
	/**
	 * Compara a configura��o
	 * 
	 * @param ou
	 *            �rg�o do usu�rio
	 * @param dtAntes
	 *            Primeira data da compara��o
	 * @param dtDepois
	 *            Segunda data da compara��o
	 * @return ArrayList<ConfiguracaoAcesso[2]> com a sincroniza��o das
	 *         configura��es nas datas
	 * @throws Exception
	 */
	@SuppressWarnings("unchecked")
