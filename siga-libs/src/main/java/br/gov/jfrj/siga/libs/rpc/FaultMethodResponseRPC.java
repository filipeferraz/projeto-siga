...
/**
 * 		� uma resposta RPC a ser enviada ao cliente em caso de erro<br/>
 * <br/> Exemplo de uso: 
 *           
 * <br/>    // Cria a resposta
 * <br/>	FaultMethodResponseRPC erro = new FaultMethodResponseRPC();
 * <br/>	erro.set(0, "isto � uma mensagem de erro" )
 * <br/>    // atribui a resposta no formato XML ao retorno
 * <br/>	setRespostaXMLStringRPC(erro.toXMLString());
 * <br/>  
 * @see	br.gov.jfrj.siga.libs.rpc.MethodResponseRPC, SimpleMethodResponseRPC
 * @author aym
 * 
 */
